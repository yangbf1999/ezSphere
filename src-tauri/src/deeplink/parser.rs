...
//!
//! Parses ezsphere:// URLs into DeepLinkImportRequest structures.
...
/// Parse a ezsphere:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// ezsphere://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "ezsphere" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'ezsphere', got '{scheme}'"
        )));
    }
