...
export const providersApi = {
  ...
  /**
   * 从 OpenCode live 配置导入模型到数据库
   * OpenCode 特有功能：由于累加模式，用户可能已在 opencode.json 中配置模型
   */
  ...
  /**
   * 获取 OpenCode live 配置中的模型 ID 列表
   * 用于前端判断模型是否已添加到 opencode.json
   */
  ...
  /**
   * 获取 OpenClaw live 配置中的模型 ID 列表
   * 用于前端判断模型是否已添加到 openclaw.json
   */
  ...
  /**
   * 获取 Hermes live 配置中的模型 ID 列表
   * 用于前端判断模型是否已添加到 Hermes 配置
   */
  ...
  /**
   * 从 OpenClaw live 配置导入模型到数据库
   * OpenClaw 特有功能：由于累加模式，用户可能已在 openclaw.json 中配置模型
   */
  ...
  /**
   * 从 Hermes live 配置导入模型到数据库
   * Hermes 特有功能：由于累加模式，用户可能已在 Hermes 配置中配置模型
   */
...
// ============================================================================
// 统一API网关（Universal API Gateway）API
// ============================================================================
