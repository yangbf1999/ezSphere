...
/** 根据 Base URL 自动检测 Coding Plan 模型；未命中返回 null */
...
/**
 * 新建 Claude 模型时，若 `ANTHROPIC_BASE_URL` 命中 Coding Plan 路由表，
