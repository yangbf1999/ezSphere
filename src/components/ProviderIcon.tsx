...
export const ProviderIcon: React.FC<ProviderIconProps> = ({
  ...
  if (iconSvg) {
    return (
      <span
        className={cn(
          "provider-icon inline-flex items-center justify-center flex-shrink-0",
          className,
        )}
        title={name}
  ...
  if (iconUrl) {
    return (
      <img
        ...
        title={name}
        className={cn(
          "provider-icon inline-flex items-center justify-center flex-shrink-0 object-contain",
          className,
        )}
