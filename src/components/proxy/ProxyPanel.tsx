      ...
      <section className="space-y-4">
        ...
        <div className="flex items-center justify-between rounded-xl border border-border bg-card/50 p-4 transition-colors hover:bg-muted/50">
          ...
          <Switch
            ...
            aria-label={t("proxyConfig.proxyEnabled", { defaultValue: "代理服务" })}
          />
        </div>
                ...
                <div className="grid gap-2 sm:grid-cols-3">
                  {(["claude", "codex"] as const).map((appType) => {
                    ...
                    return (
                      <div
                        key={appType}
                        className="rounded-md border border-primary/20 bg-background/60 px-3 py-2 mb-1"
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            ...
                            aria-label={`${appType} ${t("proxyConfig.appTakeover", { defaultValue: "应用接管" })}`}
                          />
                        </div>
                      </div>
                    );
              ...
              <div className="pt-3 border-t border-border">
                <div className="flex items-center justify-between rounded-md border border-border bg-background/60 px-3 py-2">
                  ...
                  <Switch
                    ...
                    aria-label={t("proxy.settings.fields.enableLogging.label", { defaultValue: "启用日志记录" })}
                  />
                </div>
              </div>
