      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between gap-2">
            <button
              type="button"
              className="text-sm text-muted-foreground shrink-0 cursor-pointer hover:text-foreground transition-colors inline-flex items-center gap-1 bg-transparent border-0 p-0"
          ...
          {isActiveSearch ? (
            ...
            searching ? (
              ...
              <div className="flex flex-col items-center justify-center h-48 text-muted-foreground gap-3 border-2 border-dashed border-border rounded-xl">
                <Search className="w-10 h-10 opacity-40" aria-hidden="true" />
                <p className="text-sm">
              ...
              <div className="space-y-2">
                {searchResults.map((result) => (
                  ...
                  >
                    ...
                    >
                      <Trash2 className="w-4 h-4 text-muted-foreground hover:text-destructive transition-colors" aria-hidden="true" />
                    </button>
                  </button>
                ))}
              </div>
