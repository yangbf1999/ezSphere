...
const WorkspaceFilesPanel: React.FC = () => {
  ...
  return (
    <div className="px-6 pt-4 pb-8">
      <button
        type="button"
        className="text-sm text-muted-foreground mb-6 cursor-pointer hover:text-foreground transition-colors inline-flex items-center gap-1 bg-transparent border-0 p-0"
