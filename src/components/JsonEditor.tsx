    ...
    >
      ...
      {language === "json" && (
        <button
          ...
          className={`${isFullHeight ? "mt-2 flex-shrink-0" : "mt-2"} inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-700 dark:text-gray-300 hover:text-primary transition-colors`}
        >
