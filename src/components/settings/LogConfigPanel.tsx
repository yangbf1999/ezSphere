    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg bg-muted/50 p-4 text-xs space-y-1.5">
        ...
        <div className="grid gap-1 text-muted-foreground">
          <p>
            <span className="font-mono settings-log-level-error">error</span> -{" "}
            {t("settings.advanced.logConfig.levelDesc.error")}
          </p>
          <p>
            <span className="font-mono settings-log-level-warn">warn</span> -{" "}
            {t("settings.advanced.logConfig.levelDesc.warn")}
          </p>
          <p>
            <span className="font-mono settings-log-level-info">info</span> -{" "}
            {t("settings.advanced.logConfig.levelDesc.info")}
          </p>
          <p>
            <span className="font-mono settings-log-level-debug">debug</span> -{" "}
            {t("settings.advanced.logConfig.levelDesc.debug")}
          </p>
          <p>
            <span className="font-mono settings-log-level-trace">trace</span> -{" "}
