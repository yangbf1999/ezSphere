    ...
    <div className="space-y-3">
      ...
      <div className="flex gap-2">
        <Input
          ...
          aria-label={t("settings.globalProxy.proxyUrl", { defaultValue: "代理地址" })}
        />
        <Button
          variant="outline"
          size="icon"
      ...
      <div className="flex gap-2">
        <Input
          ...
          onKeyDown={handleKeyDown}
          className="font-mono text-sm flex-1"
          aria-label={t("settings.globalProxy.username", { defaultValue: "用户名" })}
        />
        <div className="relative flex-1">
          <Input
            ...
            aria-label={t("settings.globalProxy.password", { defaultValue: "密码" })}
          />
          <Button
            type="button"
            variant="ghost"
            ...
            tabIndex={-1}
            aria-label={showPassword ? t("settings.globalProxy.hidePassword", { defaultValue: "隐藏密码" }) : t("settings.globalProxy.showPassword", { defaultValue: "显示密码" })}
          >
            {showPassword ? (
