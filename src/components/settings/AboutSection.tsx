...
> = {
  wsl: {
    ...
    className: "settings-env-badge-warning",
  },
  windows: {
    labelKey: "settings.envBadge.windows",
    className: "settings-env-badge-accent",
  },
  macos: {
    labelKey: "settings.envBadge.macos",
    className: "settings-env-badge",
  },
  linux: {
    labelKey: "settings.envBadge.linux",
    className: "settings-env-badge-success",
  },
};
...
export function AboutSection({ isPortable }: AboutSectionProps) {
  ...
  const handleOpenReleaseNotes = useCallback(async () => {
    try {
      ...
      await settingsApi.openExternal(
        `https://github.com/yangbf1999/ezsphere/releases/tag/${displayVersion}`,
      );
    } catch (error) {
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-8">
            <div className="flex flex-col items-center gap-2">
              <div className="flex items-center gap-2">
                <img src={appIcon} alt="ezSphere" className="h-5 w-5" />
          ...
          <div className="flex items-center gap-2">
            {/* <Button
              ...
              variant="outline"
              size="sm"
              onClick={() => settingsApi.openExternal("https://github.com/yangbf1999/ezsphere")}
            ...
            <Button
              ...
              onClick={() =>
                settingsApi.openExternal(
                  "https://github.com/yangbf1999/ezsphere",
                )
              }
              className="h-8 gap-1.5 text-xs"
            >
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  {isToolVersionLoading ? (
                    <Loader2 className="mt-1 h-4 w-4 animate-spin text-muted-foreground" aria-hidden="true" />
                  ) : tool?.version ? (
                    isOutdated ? (
                      ...
                      <CheckCircle2 className="mt-1 h-4 w-4 shrink-0 text-green-500" aria-hidden="true" />
                    )
                  ) : (
                    <AlertCircle className="mt-1 h-4 w-4 shrink-0 text-yellow-500" aria-hidden="true" />
                  )}
                </div>
