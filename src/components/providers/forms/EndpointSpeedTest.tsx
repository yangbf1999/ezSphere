...
import { Zap, Loader2, Plus, X, AlertCircle, Save, Globe } from "lucide-react";
...
const EndpointSpeedTest: React.FC<EndpointSpeedTestProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <Globe className="ez-modal-icon" aria-hidden="true" />
        ...
        <div className="space-y-1.5">
          <div className="flex gap-2">
            ...
            <Button
              ...
              variant="outline"
              size="icon"
              aria-label={t("endpointTest.addEndpoint")}
            >
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      aria-label={t("endpointTest.removeEndpoint", { defaultValue: "Remove endpoint" })}
