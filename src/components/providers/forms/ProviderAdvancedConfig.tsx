          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <Switch
                ...
                aria-label={t("providerAdvanced.useCustomConfig", { defaultValue: "使用单独配置" })}
              />
            </div>
            {isTestConfigOpen ? (
          ...
          <div className="border-t border-border/50 p-4 space-y-4">
            <p className="text-sm text-muted-foreground">
              {t("providerAdvanced.testConfigDesc", {
                defaultValue:
                  "为此模型配置单独的连通检测参数（超时/阈值/重试），不启用时使用全局配置。",
              })}
            </p>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <Switch
                ...
                aria-label={t("providerAdvanced.useCustomPricing", { defaultValue: "使用单独配置" })}
              />
            </div>
            {isPricingConfigOpen ? (
              <ChevronDown className="h-4 w-4 text-muted-foreground" />
